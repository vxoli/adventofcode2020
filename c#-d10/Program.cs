 ...
 namespace c__d10
{
    class Program
    {
        ...
        {
            string filename = "../d10-input.txt";
            string[] inputData = File.ReadAllLines(filename); // real data;
            int[] data = Array.ConvertAll(inputData, int.Parse);

            //int[] data = {16,10,15,5,1,11,7,19,6,12,4}; // test data;
            Array.Sort(data);
            var deviceRating = data.Max() + 3;
            var jolts = 0;
