...
// Before you can figure out whether it will impact your vacation plans, however, your device
// suddenly turns off!
// Its battery is dead.
//
...
// Any given adapter can take an input 1, 2, or 3 jolts lower than its rating and still produce its
...
fn read_input_as_string(filename: &str) -> Vec<String> {
    let input = fs::read_to_string(filename)
        .unwrap()
        .lines()
