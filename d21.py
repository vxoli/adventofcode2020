...
unsafe_ingredients = set([v for v in all_ingredients if v not in safe_ingredient])
food_dict = {key:food_dict[key] for key in sorted(food_dict.keys())}
food_dict, unsafe_ingredients
